...
bool PlopInteract::draw(const OFX::DrawArgs &args)
{
  OfxRGBColourF col;
  switch(_state) 
  {
...
bool PlopInteract::penMotion(const OFX::PenArgs &args)
{
...
bool PlopInteract::penDown(const OFX::PenArgs &args)
{
...
bool PlopInteract::penUp(const OFX::PenArgs &args)
{
  if(_state == ePicked) {
